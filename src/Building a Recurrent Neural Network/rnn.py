...
print(f'\ngradients[\"dxt\"][1][2] = {gradients_tmp["dxt"][1][2]}')
print(f'gradients[\"dxt\"].shape = {gradients_tmp["dxt"].shape}')
print(f'gradients[\"da_prev\"][2][3] = {gradients_tmp["da_prev"][2][3]}', )
print(f'gradients[\"da_prev\"].shape = {gradients_tmp["da_prev"].shape}')
print(f'gradients[\"dWax\"][3][1] = {gradients_tmp["dWax"][3][1]}')
print(f'gradients[\"dWax\"].shape = {gradients_tmp["dWax"].shape}')
print(f'gradients[\"dWaa\"][1][2] = {gradients_tmp["dWaa"][1][2]}')
print(f'gradients[\"dWaa\"].shape = {gradients_tmp["dWaa"].shape}')
print(f'gradients[\"dba\"][4] = {gradients_tmp["dba"][4]}')
print(f'gradients[\"dba\"].shape = {gradients_tmp["dba"].shape}')
...
print(f'gradients[\'dx\'][1][2] = {gradients_tmp["dx"][1][2]}')
print(f'gradients[\'dx\'].shape = {gradients_tmp["dx"].shape}')
print(f'gradients[\'da0\'][2][3] = {gradients_tmp["da0"][2][3]}')
print(f'gradients[\'da0\'].shape = {gradients_tmp["da0"].shape}')
print(f'gradients[\'dWax\'][3][1] = {gradients_tmp["dWax"][3][1]}')
print(f'gradients[\'dWax\'].shape = {gradients_tmp["dWax"].shape}')
print(f'gradients[\'dWaa\'][1][2] = {gradients_tmp["dWaa"][1][2]}')
print(f'gradients[\'dWaa\'].shape = {gradients_tmp["dWaa"].shape}')
...
print("\ngradients[\"dx\"][1][2] =", gradients_tmp["dx"][1][2])
